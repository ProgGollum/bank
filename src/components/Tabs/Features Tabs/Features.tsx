                            ...
                            <ul className={s.features__cards}>
                                <li className={s.features__card}>
                                    <div className={s.features__card_name}>
                                        ...
                                        <MdArrowOutward size={"2rem"} color={"#CAFF33"}/>
                                    </div>
                                ...
                                <li className={s.features__card}>
                                    ...
                                    <p className={s.features__card_text}>
                                        Stay connected to your finances on the go with our user-friendly mobile banking app. Easily manage your accounts,
                                ...
                                <li className={s.features__card}>
                                    ...
                                    <p className={s.features__card_text}>
                                        Rest assured knowing that your transactions are protected by industry-leading security measures. We employ encryption
                                ...
                                <li className={s.features__card}>
                                    ...
                                    <p className={s.features__card_text}>
                                        Save time and avoid late fees with our convenient bill pay service. Set up recurring payments or make one-time transfers
